  ...
  return (
    <footer>
      <ul className="footer_categories">
        ...
        <li>
          <Link to="/posts/categories/Buisness">Buisness</Link>
        </li>
        <li>
          <Link to="/posts/categories/Education">Buisness</Link>
        </li>
        <li>
      ...
      <div className="footer_copyright">
        <small>All Rights Reserved &copy; Copyright,Ritesh Gore.</small>
      </div>
    </footer>
  );
};
